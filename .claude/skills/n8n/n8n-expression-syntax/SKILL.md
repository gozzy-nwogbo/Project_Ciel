...
Trigger: "n8n expression", "{{}} syntax", "$json variable", "expression error", "webhook data access"
Output artifact: Corrected n8n expression string or expression pattern reference
