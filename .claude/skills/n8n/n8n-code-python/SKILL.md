...
Trigger: "write python in n8n", "n8n python code node", "_input syntax", "python standard library n8n"
Output artifact: Python code block for n8n Code node configuration
