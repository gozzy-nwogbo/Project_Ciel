...
Trigger: "n8n workflow pattern", "build n8n workflow", "workflow architecture", "webhook processing", "AI agent workflow", "scheduled task"
Output artifact: Workflow pattern specification with node list, connection map, and configuration checklist
