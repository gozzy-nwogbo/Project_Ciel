...
Trigger: "configure n8n node", "n8n property dependencies", "n8n required fields", "get_node detail level", "node configuration pattern"
Output artifact: Node configuration JSON object with operation-specific required fields
