...
Trigger: "n8n validation error", "validation warning", "false positive", "operator structure", "validation profile", "validation loop"
Output artifact: Diagnosis of validation error with fix instructions or corrected configuration JSON
