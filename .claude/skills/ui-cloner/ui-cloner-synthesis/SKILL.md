# Skill: ui-cloner-synthesis

Pipeline Step 3 of 6 in the UI Cloner (SRIP) pipeline. Takes the Site DNA and all 12 brand interview answers to generate a one-shot replication prompt a developer can paste into any code generation tool. Applies 11 synthesis rules covering design system adaptation, color substitution, animation intensity scaling, and copy voice matching. Trigger: "synthesize replication prompt", "run phase 3", "generate build prompt". Output artifact: `plans/03-replication-prompt.md`.
