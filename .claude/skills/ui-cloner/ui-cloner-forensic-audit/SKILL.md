# Skill: ui-cloner-forensic-audit

Pipeline Step 1 of 6 in the UI Cloner (SRIP) pipeline. Performs a forensic analysis of a target website, running steps 1.1 through 1.9 to extract every design token, motion pattern, and interaction behavior. Trigger: "forensic audit [URL]", "analyze site DNA", "run phase 1 audit". Output artifact: `plans/01-site-dna.md` (Site DNA document).
