# Skill: ui-cloner-brand-interview

Pipeline Step 2 of 6 in the UI Cloner (SRIP) pipeline. Presents all 12 brand identity questions to the user in a single message after the forensic audit completes, collecting product identity, audience, color palette, section preferences, animation intensity, and tech stack. Trigger: "brand interview", "run phase 2", "collect brand info". Output artifact: `plans/02-brand-interview.md`.
