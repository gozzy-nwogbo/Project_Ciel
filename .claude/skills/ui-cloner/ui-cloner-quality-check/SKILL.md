# Skill: ui-cloner-quality-check

Pipeline Step 6 of 6 in the UI Cloner (SRIP) pipeline. Runs a multi-domain fidelity checklist against the generated replication prompt before delivery, checking layout, visual composition, animation, interaction, design system, and technical fidelity. Patches missing elements inline. Trigger: "quality check prompt", "run phase 4", "verify replication prompt". Output artifact: `plans/04-final-prompt.md`.
