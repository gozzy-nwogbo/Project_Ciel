...
| Skill | Trigger Phrases | Path | Audit | Last Eval |
|-------|----------------|------|-------|-----------|
| `linkedin-visual-discipline` | "render visual", "tier 1 diagram", "review carousel", "visual brief", "review the bundle" | .claude/skills/linkedin/visual-discipline/ | DRAFT | 2026-05-25 |
